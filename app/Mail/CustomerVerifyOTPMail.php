...
class CustomerVerifyOTPMail extends Mailable
{
    ...
    public function build()
    {
        ...
        $emailContent = EmailTemplate::where('title', 'Email OTP Verification')->get()->first();
        $verifyCode = CustomerVerification::insertEmailCode($this->data->id)->email_code;
        //
