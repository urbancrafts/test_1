...
<head>
  ...
  <link rel="stylesheet" href="{{asset('plugins_2/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css')}}">
  <!-- iCheck -->
  <link rel="stylesheet" href="{{asset('plugins_2/icheck-bootstrap/icheck-bootstrap.min.css')}}">
  <!-- JQVMap -->
  <link rel="stylesheet" href="{{asset('plugins_2/jqvmap/jqvmap.min.css')}}">
  <!-- Theme style -->
  <link rel="stylesheet" href="{{asset('dist_2/css/adminlte.min.css')}}">
  <!-- overlayScrollbars -->
  <link rel="stylesheet" href="{{asset('plugins_2/overlayScrollbars/css/OverlayScrollbars.min.css')}}">
  <!-- Daterange picker -->
  <link rel="stylesheet" href="{{asset('plugins_2/daterangepicker/daterangepicker.css')}}">
  <!-- summernote -->
  <link rel="stylesheet" href="{{asset('plugins_2/summernote/summernote-bs4.min.css')}}">
...
$(".dropdown-toggle").on("click", function(e){
  ...
  $.ajax({
			...
			'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
				 ...
				 type: "POST",
			   dataType: "json",
			   url: "{{ action('App\Http\Controllers\NotificationController@notification_bar') }}",
			   data: {"action": "loadNoteBar"},
			   beforeSend:function(){
				   $(".load-note-bar").html("<div class='load'>Opening<img src='{{ asset('loaders/loader.gif')}}'/ ></div>");
			   },
			   complete:function(){
				   $(".load").remove();
			   },
			   error:function(){
          $(".load-note-bar").html("<div class='errLoading'><img src='{{asset('icons/ic_connections.png')}}'/ > Please check your internet connection</div>");
			   },
			   success:function(data){
				   if(data.success == true){
          ...
          for(i = 0; i < data.data.notification.length; i++){
              if(data.data.notification[i].note_type == "Transaction"){
                note_body += "\r\n<a href=\'{{url('admin/notifications')}}/"+data.data.notification[i].id+"\' class=\'dropdown-item\'><i class=\'fas fa-money mr-2\'><\/i>"+data.data.tranCounter+" "+data.data.notification[i].note_type+" <span class=\'float-right text-muted text-sm\'><\/span> <\/a><div class=\'dropdown-divider\'><\/div>\r\n";
              }else if(data.data.notification[i].note_type == "Subscription"){
                note_body += "\r\n<a href=\'{{url('admin/notifications')}}/"+data.data.notification[i].id+"\' class=\'dropdown-item\'><i class=\'fas fa-users mr-2\'><\/i>"+data.data.subCounter+" "+data.data.notification[i].note_type+" <span class=\'float-right text-muted text-sm\'><\/span><\/a><div class=\'dropdown-divider\'><\/div>\r\n";
              }else if(data.data.notification[i].note_type == "Comment"){
                note_body += "\r\n<a href=\'{{ url('admin/notifications') }}/"+data.data.notification[i].id+"\' class=\'dropdown-item\'><i class=\'fas fa-commenting mr-2\'><\/i>"+data.data.comCounter+" "+data.data.notification[i].note_type+" <span class=\'float-right text-muted text-sm\'><\/span><\/a><div class=\'dropdown-divider\'><\/div>\r\n";
              }
          }
          ...
          var html_data = "\r\n<span class=\'dropdown-item dropdown-header\'>\r\n "+hint_note+" <\/span>\r\n  <div class=\'dropdown-divider\'><\/div>\r\n "+note_body+" <a href=\'{{url('admin/notifications')}}\' class=\'dropdown-item dropdown-footer\'>See All Notifications<\/a>\r\n";
  ...
  if(str == true){
    $.ajax({
      ...
      'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
         ...
         type: "POST",
         dataType: "json",
         url: "{{ action('App\Http\Controllers\AjaxRequestController@update_debt') }}",
         data: {"uid":id},
         beforeSend:function(){  
         },
         complete:function(){  
  ...
  if(str == true){
    $.ajax({
      ...
      'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
         ...
         type: "POST",
         dataType: "json",
         url: "{{ action('App\Http\Controllers\AjaxRequestController@delete_user') }}",
         data: {"uid":id},
         beforeSend:function(){  
         },
         complete:function(){  
  ...
  if(str == true){
    $.ajax({
      ...
      'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
         ...
         type: "POST",
         dataType: "json",
         url: "{{ action('App\Http\Controllers\AjaxRequestController@update_reservation_resources') }}",
         data: {"uid":id},
         beforeSend:function(){  
         },
         complete:function(){  
  ...
  if(str == true){
    $.ajax({
      ...
      'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
         ...
         type: "POST",
         dataType: "json",
         url: "{{ action('App\Http\Controllers\AjaxRequestController@update_reservation_availability') }}",
         data: {"uid":id},
         beforeSend:function(){  
         },
         complete:function(){  
  ...
  if(str == true){
    $.ajax({
      ...
      'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
         ...
         type: "POST",
         dataType: "json",
         url: "{{ action('App\Http\Controllers\AjaxRequestController@update_booking_approval') }}",
         data: {"uid":id},
         beforeSend:function(){  
         },
         complete:function(){  
  ...
  if(str == true){
    $.ajax({
      ...
      'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
         ...
         type: "POST",
         dataType: "json",
         url: "{{ action('App\Http\Controllers\AjaxRequestController@update_booking_availability') }}",
         data: {"uid":id},
         beforeSend:function(){  
         },
         complete:function(){  
...
function noteCounter(){
  $.ajax({
      ...
      'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
         ...
         type: "POST",
         dataType: "json",
         url: "{{ action('App\Http\Controllers\NotificationController@notification_counter') }}",
         data: {"loadData": "load"},
         beforeSend:function(){  
         },
         complete:function(){  
...
function msgNoteCounter(){
  $.ajax({
      ...
      'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
         ...
         type: "POST",
         dataType: "json",
         url: "{{ action('App\Http\Controllers\NotificationController@msg_note') }}",
         data: {"loadData": "load"},
         beforeSend:function(){  
         },
         complete:function(){  
...
function newsLetterCounter(){ 
  $.ajax({
      ...
      'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
         ...
         type: "POST",
         dataType: "json",
         url: "{{ action('App\Http\Controllers\NotificationController@news_letter_note') }}",
         data: {"loadData": "load"},
         beforeSend:function(){  
         },
         complete:function(){  
...
function supportNoteCounter(){
  $.ajax({
      ...
      'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
         ...
         type: "POST",
         dataType: "json",
         url: "{{ action('App\Http\Controllers\NotificationController@support_note') }}",
         data: {"loadData": "load"},
         beforeSend:function(){  
         },
         complete:function(){  
