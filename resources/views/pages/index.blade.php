	...
	jQuery("#check-avail-form").on("submit", function(e){
      ...
      'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')
         ...
         beforeSend:function(){
			...
			jQuery('#search-btn').html("<img src='{{ asset('loaders/AjaxLoader.gif') }}' />");
                ...
                for(var i = 0; i < data.data.length; i++){
					if(data.data[i].img_1 != null){
						if(search_option == "Resort"){
							jQuery("#load_search_result").append("\r\n<li id=\'room-"+data.data[i].id+"\' class=\'hb_room post-56 type-hb_room status-publish has-post-thumbnail hentry hb_room_type-balcony hb_room_type-lake-view\'><div class=\'summary entry-summary\'><div class=\'media\'><a href=\'{{url('resorts/resort')}}/"+data.data[i].id+"\'><img src=\'"+data.data[i].img_1+"\' width=\'500\' height=\'575\' alt=\'\'><\/a><\/div><div class=\'room-caption\'><div class=\'title\'><h4><a href=\'{{url('resorts/resort')}}/"+data.data[i].id+"\'>"+data.data[i].name+"<\/a><\/h4><\/div><div class=\'room-meta\'><span class=\'room-type\'><span><a href=\'#\'>"+data.data[i].location+"<\/a><\/span><\/span><\/div><div class=\'price\'><span class=\'title-price\'>Price<\/span><span class=\'price_value price_min\'>"+data.data[i].curr+data.data[i].price+"<\/span><span class=\'unit\'>"+data.data[i].duration+"<\/span><\/div><a href=\'{{url('resorts/resort')}}/"+data.data[i].id+"\' class=\'room-button\'><i class=\'foxuries-icon-long-arrow-right\'><\/i><span>See details<\/span><\/a> <\/div><\/div><\/li>\r\n");
						}else if(search_option == "Boat"){
							jQuery("#load_search_result").append("\r\n<li id=\'room-"+data.data[i].id+"\' class=\'hb_room post-56 type-hb_room status-publish has-post-thumbnail hentry hb_room_type-balcony hb_room_type-lake-view\'><div class=\'summary entry-summary\'><div class=\'media\'><a href=\'{{url('boats/boat')}}/"+data.data[i].id+"\'><img src=\'"+data.data[i].img_1+"\' width=\'500\' height=\'575\' alt=\'\'><\/a><\/div><div class=\'room-caption\'><div class=\'title\'><h4><a href=\'{{url('boats/boat')}}/"+data.data[i].id+"\'>"+data.data[i].title+"<\/a><\/h4><\/div><div class=\'room-meta\'><span class=\'room-type\'><span><a href=\'#\'>"+data.data[i].location+"<\/a><\/span><\/span><\/div><div class=\'price\'><span class=\'title-price\'>Price<\/span><span class=\'price_value price_min\'>"+data.data[i].curr+data.data[i].price+"<\/span><span class=\'unit\'>"+data.data[i].duration+"<\/span><\/div><a href=\'{{url('boats/boat')}}/"+data.data[i].id+"\' class=\'room-button\'><i class=\'foxuries-icon-long-arrow-right\'><\/i><span>See details<\/span><\/a> <\/div><\/div><\/li>\r\n");
...
jQuery("#location").on('keyup', function(e){
 ...
 if(e.keyCode == 40 || e.keyCode == 38 || e.keyCode == 13){
      ...
      'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')
           ...
           type: "POST",
         dataType: "json",
         url: "{{ action('App\Http\Controllers\AjaxRequestController@load_resort_location_search') }}",
...
**********************************************************************/
	...
	<body onload="initAutocomplete()" class="home page-template page-template-template-homepage page-template-template-homepage-php page page-id-73 wp-embed-responsive foxuries-full-width-content foxuries-footer-builder elementor-default elementor-kit-75 elementor-page elementor-page-73">
		...
		<div class="elementor-element elementor-element-6c8828c elementor-section-stretched elementor-reverse-tablet elementor-reverse-mobile elementor-section-boxed elementor-section-height-default elementor-section-height-default elementor-section elementor-top-section" data-id="6c8828c" data-element_type="section" data-settings="{&quot;stretch_section&quot;:&quot;section-stretched&quot;,&quot;background_background&quot;:&quot;classic&quot;}">
			...
			<a href="{{ url('about_us') }}" class="elementor-button-link elementor-button elementor-size-sm" role="button">
			...
			<div class="elementor-widget-container">
			<div class="elementor-button-wrapper">
			<a href="{{ url('blog/category/kitchen')}}" class="elementor-button-link elementor-button elementor-size-sm" role="button">
			<span class="elementor-button-content-wrapper">
			<span class="elementor-button-icon elementor-align-icon-left">
			<i aria-hidden="true" class="foxuries-icon- foxuries-icon-long-arrow-right"></i> </span>
			...
			<div class="elementor-widget-container">
			<div class="elementor-button-wrapper">
			<a href="{{ url('blog/category/beach_sports') }}" class="elementor-button-link elementor-button elementor-size-sm" role="button">
			<span class="elementor-button-content-wrapper">
			<span class="elementor-button-icon elementor-align-icon-left">
			<i aria-hidden="true" class="foxuries-icon- foxuries-icon-long-arrow-right"></i> </span>
			...
			<div class="elementor-widget-container">
			<div class="elementor-button-wrapper">
			<a href="{{ url('register/signup_members') }}" class="elementor-button-link elementor-button elementor-size-sm" role="button">
			<span class="elementor-button-content-wrapper">
			<span class="elementor-button-icon elementor-align-icon-left">
			<i aria-hidden="true" class="foxuries-icon- foxuries-icon-long-arrow-right"></i> </span>
         ...
         @include('pages.index-room-show')
			...
			@foreach ($contents as $content)
				@if ($content->name == "why_you_should_choose_us")
					{!!$content->value!!}
				@endif
			@endforeach
			...
			<div class="elementor-text-editor elementor-clearfix"><span>
				@foreach ($contents as $content)
				@if ($content->name == "boat_and_yacht_cruise")
					{!!$content->value!!}
				@endif
			@endforeach	
			</span></div>
            ...
            @include('pages.index-blog-field')
			</div>
		    </div>
			</div>
			</div>
