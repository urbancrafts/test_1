    ...
    jQuery("#shop-category").on("change", function(e){
      ...
      'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')
         ...
         success:function(data){
            ...
            jQuery("#load-shop").append("\r\n<li id=\'room-"+data.data[i].id+"\' class=\'hb_room post-56 type-hb_room status-publish has-post-thumbnail hentry hb_room_type-balcony hb_room_type-lake-view\'><div class=\'summary entry-summary\'><div class=\'media\'><a href=\'{{url('shop')}}/"+data.data[i].category+"/"+data.data[i].id+"\'><img src=\'"+data.data[i].img_1+"\' width=\'500\' height=\'575\' alt=\'\'><\/a><\/div><div class=\'room-caption\'><div class=\'title\'><h4><a href=\'{{url('shop')}}/"+data.data[i].category+"/"+data.data[i].id+"\'>"+data.data[i].item_name+"<\/a><\/h4><\/div><div class=\'room-meta\'><span class=\'room-type\'><span><a href=\'#\'>"+data.data[i].location+"<\/a><\/span><\/span><\/div><div class=\'price\'><span class=\'title-price\'>Price<\/span><span class=\'price_value price_min\'>"+data.data[i].curr+data.data[i].price+"<\/span><span class=\'unit\'>"+data.data[i].discount_percent+"% discount<\/span><\/div><a href=\'#content\'  id=\'cart-button_"+data.data[i].id+"\' data-id=\'"+data.data[i].id+"\' class=\'room-button\' onClick=\'addToCart(this.id)\'><i class=\'ion ion-bag\'><\/i><span>Add to cart<\/span><\/a> <\/div><\/div><\/li>\r\n");
    ...
    function loadHomeBlog($record_per_page, $start){
      ...
      jQuery.ajax({
        ...
        'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')
           ...
           type: "POST",
           dataType: "json",
           url: "{{ action('App\Http\Controllers\AjaxRequestController@load_shop_data') }}",
  ...
  alert('Invalid request ID');
    ...
    jQuery.ajax({
      ...
      'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')
           ...
           type: "POST",
         dataType: "json",
         url: "{{ action('App\Http\Controllers\AjaxRequestController@add_to_cart') }}",
