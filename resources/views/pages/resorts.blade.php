        ...
        function loadHomeBlog($record_per_page, $start){
          ...
          jQuery.ajax({
            ...
            'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')
               ...
               type: "POST",
               dataType: "json",
               url: "{{ action('App\Http\Controllers\AjaxRequestController@load_resort_data') }}",
               data: {"record_per_page": $record_per_page, "start": $start, "action": $action},
               beforeSend:function(){
			//jQuery("#search-btn").prop('disabled', true);
			jQuery('#resort-loader').html("<div class='load'><img src='{{ asset('loaders/AjaxLoader.gif') }}' /></div>");
