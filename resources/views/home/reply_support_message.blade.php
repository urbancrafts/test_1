...
if($.trim($('#receipient').val()) == ""){
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Admin
        <small>reply contact message </small>
      </h1>
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-9">
            ...
            <form id="msg-form" action="{{ action('App\Http\Controllers\AjaxRequestController@reply_contact_msg') }}">
            <div class="card card-primary card-outline">
              ...
              <div class="card-header">
                <h3 class="card-title">Reply contact us message</h3>
              </div>
              <!-- /.box-header -->
              <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2" name="receipient[]" id="receipient" multiple="multiple" data-placeholder="Send to"
                            style="width: 100%;">
                        <option value="{{$supports[0]->email}}" selected>{{$supports[0]->email}}</option>
                ...
                <div class="form-group">
                  <input class="form-control" name="subject" id="subject" placeholder="Subject:" value="Reply: {{$supports[0]->subject}}">
                </div>
                <div class="form-group">
