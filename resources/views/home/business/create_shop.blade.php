      ...
      'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
         ...
         success:function(data){
            if(data.success == true){
             ...
             $("#sendEmail").prop('disabled', false);
             $('#sendEmail').html("Submit");
             window.location = "{{ url('') }}/admin/shop_manager/edit_shop_img/"+data.data.id;
            //location.reload();
      ...
      <div class="row">
       ...
       @if(Auth::user()->user_type == "admin")
          <div class="card card-info">
            ...
            <div class="card-body">
              <form id="shop_category_form" action="{{ action('App\Http\Controllers\ShopController@create_categories') }}" method="post" enctype="multipart/form-data">
        ...
        <label>{{$category->category}}<a href="#" class="fas fa-trash" onclick="deleteCategory('{{$category->id}}','{{$category->category}}')" title="Delete {{$category->category}}"></a></label>       
          ...
          @endif
            ...
            <div class="card card-info">
                ...
                <div class="card-body">
                  <form id="new-shop-form" action="{{ action('App\Http\Controllers\ShopController@create_new_product') }}" method="post" enctype="multipart/form-data">
        ...
        <section class="col-lg-5 connectedSortable">
            ...
            <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                 ...
                 @if (Auth::user()->role == 1 || Auth::user()->user_type == "admin" || $shop->created_by == Auth::user()->id)
                 ...
                 <tr class="item" >
                  ...
                  <div class="product-info">
                    <a href="{{ url('shop/product/'.$shop->id) }}" class="product-title">{{$shop->item_name}}
                      
                      
                      <span class="badge badge-warning float-right">
                          {{$shop->curr}}{{$shop->price}}
                        </span>
                    ...
                    <span class="product-description">
                        ...
                        <a href="#" class="fa fa-trash del-btn" onclick="deleteService('{{$shop->id}}','{{$shop->item_name}}')" title="Delete {{$shop->item_name}}">Delete</a> | 
                        <a href="{{ url('admin/shop_manager/edit_shop/'.$shop->id) }}" class="fa fa-edit edit-btn" title="Edit {{$shop->item_name}}">Edit</a> | 
                        <a href="{{url('admin/shop_manager/product_order/'.$shop->id)}}" class="fa fa-book book-btn" title="Check {{$shop->item_name}} orders">Orders</a>
