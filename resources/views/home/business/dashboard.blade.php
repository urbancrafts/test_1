...
<!-- jQuery Mapael -->
<script src="{{asset('plugins_2/jquery-mousewheel/jquery.mousewheel.js')}}"></script>
<script src="{{asset('plugins_2/raphael/raphael.min.js')}}"></script>
<script src="{{asset('plugins_2/jquery-mapael/jquery.mapael.min.js')}}"></script>
<script src="{{asset('plugins_2/jquery-mapael/maps/usa_states.min.js')}}"></script>
<script src="{{asset('plugins_2/chart.js/Chart.min.js')}}"></script>
