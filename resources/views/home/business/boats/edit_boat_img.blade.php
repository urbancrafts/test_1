...
if(str == true){
  $.ajax({
      ...
      'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
         ...
         type: "POST",
         dataType: "json",
         url: "{{ action('App\Http\Controllers\BoatController@remove_boat_img') }}",
...
<div class="wrapper">   
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Business Account
        <small>Boat owner: {{$boats[0]->model}}</small>
      </h1>
          ...
          <div class="tabSide">
            <div class="card card-body p-0" style="border: 2px solid #E51924; border-radius: 0px">
                <ul class="nav nav-pills nav-justified">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="{{url('admin/boat_manager/edit_boat/'.$boats[0]->id)}}">Edit form</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link active" href="{{url('admin/boat_manager/edit_boat_img/'.$boats[0]->id)}}">Images</a>
                  </li>
                  <li class="nav-item">
  ...
  <!-- <li class="nav-item">
   ...
   -->
          ...
          <form id="img-form" method="post" action="{{ action('App\Http\Controllers\BoatController@update_boat_img') }}" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="boat" id="boat" value="{{$boats[0]->id}}">
                      ...
                      <div class="card mb-0">
                          <div class="card-header">
                              <div class="d-flex justify-content-between">
                                  ...
                                  <div>
                                      <button onclick="removeImg('{{$boats[0]->id}}', '{{$key}}')" class="btn btn-danger btn-sm" type="button"><i class="fa fa-trash"></i></button>
                                  </div>
                              </div>
            ...
            <a href="{{url('admin/boat_manager/bookings/'.$boats[0]->id)}}" class="btn btn-primary rounded-0 pt-3 pb-3" type="submit">SAVE AND CONTINUE</a>
            </div>
