@extends('layouts.app')
  ...
  <!-- DayPilot library -->
  <script src="{{ asset('dashboard_calendar/js/date/booking_calendar.js')}}"></script>
...
function updateRoom(sub_id, name, capacity, status){
  ...
  jQuery.ajax({
      ...
      'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')
         ...
         type: "POST",
         dataType: "json",
         url: "{{ action('App\Http\Controllers\ResortController@sub_room_update') }}",
...
function createRoomReservation(resort_id, room_id, start, end, sub_room_id, customer, e){
  jQuery.ajax({
      ...
      'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')
         ...
         type: "POST",
         dataType: "json",
         url: "{{ action('App\Http\Controllers\ReservationController@admin_room_reservation_create') }}",
...
function updateRoomReservation(id, name, start, end, resource, status, paid, bubble, e){
  jQuery.ajax({
      ...
      'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')
         ...
         type: "POST",
         dataType: "json",
         url: "{{ action('App\Http\Controllers\ReservationController@admin_room_reservation_update') }}",
...
function resizeRoomReservation(id, start, end){
  jQuery.ajax({
      ...
      'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')
         ...
         type: "POST",
         dataType: "json",
         url: "{{ action('App\Http\Controllers\ReservationController@admin_room_reservation_resize') }}",
...
function moveRoomReservation(id, newStart, newEnd, newResource){
  ...
  jQuery.ajax({
      ...
      'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')
         ...
         type: "POST",
         dataType: "json",
         url: "{{ action('App\Http\Controllers\ReservationController@admin_room_reservation_move') }}",
        ...
        <div class="tabSide">
          <div class="card card-body p-0" style="border: 2px solid #E51924; border-radius: 0px">
            ...
            <ul class="nav nav-pills nav-justified">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="{{url('admin/service_manager/bookings/'.$services[0]->id)}}">Bookings</a>
              </li>
              <!-- <li class="nav-item">
