...
if($.trim($('#boat').val()) == ""){
      ...
      'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
         ...
         success:function(data){
            if(data.success == true){
             ...
             $("#sendEmail").prop('disabled', false);
             $('#sendEmail').html("Submit");
             window.location = "{{ url('') }}/admin/boat_manager/edit_boat_img/"+boat;
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Boat
        <small>Edit {{$boats[0]->title}}</small>
      </h1>
  ...
  <li class="nav-item">
    <a class="nav-link active" href="{{url('admin/boat_manager/edit_boat/'.$boats[0]->id)}}">Edit form</a>
  </li>
  <li class="nav-item">
    <a class="nav-link " href="{{url('admin/boat_manager/edit_boat_img/'.$boats[0]->id)}}">Images</a>
  </li>
  <li class="nav-item">
    <a class="nav-link " href="{{url('admin/boat_manager/bookings/'.$boats[0]->id)}}">Bookings</a>
  </li>
        ...
        <section class="col-lg-7 connectedSortable" id="blog-body">
            ...
            <div class="card card-info">
                <div class="card-header">
                  ...
                  <h3 class="card-title"><i class="fa fa-ship"></i> {{$boats[0]->title}}</h3>
                  <!-- tools box -->
                ...
                <div class="card-body">
                  <form id="update-boat-form" action="{{ action('App\Http\Controllers\BoatController@update_boat') }}" method="post" enctype="multipart/form-data">
                    <input type='hidden' id='uid' name='uid' value='{{ Auth::user()->id }}' />
                   <input type='hidden' id='boat' name='boat' value='{{$boats[0]->id}}' />
                    
                   <div class="form-group">
                    <label>Category:</label>
                   <input type="text" class="form-control" id="category" name="category" value="{{$boats[0]->category}}" disabled>
                   </div>
                   <div class="form-group">
                    <label>Model:</label>
                        <span style="color: red;" class="boat-model-error">*</span>
                      <input type="text" class="form-control" id="model" name="model" onfocus="elementFocus(this.id, 'boat-model-error')" placeholder="Enter Model" value="{{$boats[0]->title}}">
                    </div>
                    ...
                    <div class="form-group">
                      <label>Price/hour:</label>
                        ...
                        <input type="number" class="form-control" id="price" name="price" onfocus="elementFocus(this.id, 'boat-price-error')" placeholder="price" value="{{$boats[0]->price}}">
                      </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control pac-target-input valid" id="location" name="location" onfocus="elementFocus(this.id, 'boat-location-error')"  value="{{$boats[0]->location}}" data-validation="required" placeholder="Enter a location" autocomplete="off">
                      ...
                      <div class="form-group">
                        ...
                        <input type="url" class="form-control pac-target-input valid" id="youtube" name="youtube" value="{{$boats[0]->youtube}}" placeholder="Enter youtube video link" autocomplete="off">
                    ...
                    <div class="form-group">
                      ...
                      <textarea id="address" name="address" placeholder="Boat address"
                                style="width: 100%; height: 70px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$boats[0]->address}}</textarea>
                    </div>
                      </div>
                    ...
                    <textarea id="desc" name="desc" placeholder="Enter description"
                                style="width: 100%; height: 70px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$boats[0]->about}}</textarea>
                    </div>
                      </div>
