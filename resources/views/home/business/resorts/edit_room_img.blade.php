...
if(str == true){
  $.ajax({
      ...
      'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
         ...
         type: "POST",
         dataType: "json",
         url: "{{ action('App\Http\Controllers\ResortController@remove_resort_room_img') }}",
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="col-md-12 grid-margin">
          ...
          <div class="tabSide">
            <div class="card card-body p-0" style="border: 2px solid #E51924; border-radius: 0px">
              ...
              <ul class="nav nav-pills nav-justified">
                ...
                <li class="nav-item">
                  <a class="nav-link active" href="{{url('admin/resort_manager/edit_room_img/'.$rooms[0]->shelter_id.'/'.$rooms[0]->id)}}">Images</a>
                </li>
                <li class="nav-item">
          ...
          <form id="img-form" method="post" action="{{ action('App\Http\Controllers\ResortController@update_resort_room_img') }}" enctype="multipart/form-data">
            @csrf
                      ...
                      <div class="card mb-0">
                          <div class="card-header">
                              <div class="d-flex justify-content-between">
                                  ...
                                  <div>
                                      <button onclick="removeImg('{{$rooms[0]->id}}', '{{$key}}')" class="btn btn-danger btn-sm" type="button"><i class="fa fa-trash"></i></button>
                                  </div>
                              </div>
            ...
            <a href="{{url('admin/resort_manager/book_room/'.$rooms[0]->shelter_id.'/'.$rooms[0]->id)}}" class="btn btn-primary rounded-0 pt-3 pb-3" type="submit">SAVE AND CONTINUE</a>
            </div>
