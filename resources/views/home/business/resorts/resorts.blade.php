      ...
      'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
         ...
         success:function(data){
            if(data.success == true){
             ...
             window.location = "{{ url('') }}/admin/resort_manager/edit_resort_img/"+data.data.id;           
             //location.reload();
  ...
  if(str == true){
    $.ajax({
      ...
      'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
         ...
         type: "POST",
         dataType: "json",
         url: "{{ action('App\Http\Controllers\ResortController@delete_resort') }}",
         data: {"uid":id},
         beforeSend:function(){  
         },
         complete:function(){  
      ...
      <div class="row">
       ...
       @if(Auth::user()->user_type == "admin")
          <div class="card card-info">
            ...
            <div class="card-body">
              <form id="resort_feature_form" action="{{ action('App\Http\Controllers\ResortController@create_resort_feature') }}" method="post" enctype="multipart/form-data">
                 ...
                 <tr class="item" >
                  ...
                  <div class="product-info">
                    ...
                    <span class="product-description">
                        ...
                        <a href="{{ url('admin/resort_manager/resort/'.$resort->id) }}" class="fa fa-edit edit-btn" title="Edit {{$resort->name}}">Edit</a> | 
                        <a href="{{url('admin/resort_manager/bookings/'.$resort->id)}}" class="fa fa-book book-btn" title="Book {{$resort->name}}">Bookings</a>
