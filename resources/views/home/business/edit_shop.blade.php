      ...
      'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
         ...
         success:function(data){
            if(data.success == true){
             ...
             $("#sendEmail").prop('disabled', false);
             $('#sendEmail').html("Submit");
             window.location = "{{ url('') }}/admin/shop_manager/edit_shop_img/"+shop;
          ...
          <div class="tabSide">
            <div class="card card-body p-0" style="border: 2px solid #E51924; border-radius: 0px">
                <ul class="nav nav-pills nav-justified">
                  <li class="nav-item">
                    <a class="nav-link active" href="{{url('admin/shop_manager/edit_shop/'.$shops[0]->id)}}">Edit form</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{url('admin/shop_manager/edit_shop_img/'.$shops[0]->id)}}">Images</a>
                  </li>
                  <li class="nav-item">
        ...
        <section class="col-lg-7 connectedSortable" id="blog-body">
            ...
            <div class="card card-info">
                <div class="card-header">
                  ...
                  <h3 class="card-title"><i class="ico ico-bag"></i> {{$shops[0]->item_name}}</h3>
                  <!-- tools box -->
                ...
                <div class="card-body">
                  <form id="update-shop-form" action="{{ action('App\Http\Controllers\ShopController@update_product') }}" method="post" enctype="multipart/form-data">
                    <input type='hidden' id='uid' name='uid' value='{{ Auth::user()->id }}' />
                   <input type='hidden' id='shop' name='shop' value='{{$shops[0]->id}}' />
                    
                   <div class="form-group">
                    <label>Category:</label>
                   <input type="text" class="form-control" id="category" name="category" value="{{$shops[0]->category}}" disabled>
                   </div>
                   <div class="form-group">
                    <label>Item Name:</label>
                        <span style="color: red;" class="shop-name-error">*</span>
                      <input type="text" class="form-control" id="name" name="name" onfocus="elementFocus(this.id, 'shop-name-error')" placeholder="Enter Shop Item Name" value="{{$shops[0]->item_name}}">
                    </div>
                    ...
                    <div class="form-group">
                      <label>Price:</label>
                        ...
                        <input type="number" class="form-control" id="price" name="price" onfocus="elementFocus(this.id, 'shop-price-error')" placeholder="price" value="{{$shops[0]->price}}">
                      </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control pac-target-input valid" id="location" name="location" onfocus="elementFocus(this.id, 'shop-location-error')"  value="{{$shops[0]->location}}" data-validation="required" placeholder="Enter a location" autocomplete="off">
                      ...
                      <div class="form-group">
                        ...
                        <input type="url" class="form-control pac-target-input valid" id="youtube" name="youtube" value="{{$shops[0]->youtube}}" placeholder="Enter youtube video link" autocomplete="off">
                    ...
                    <textarea id="desc" name="desc" placeholder="Enter description"
                                style="width: 100%; height: 70px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$shops[0]->desc}}</textarea>
                    </div>
                      </div>
