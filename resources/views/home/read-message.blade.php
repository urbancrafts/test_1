      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="card card-primary card-outline">
            <div class="card-header with-border">
              <h3 class="card-title">read inbox message</h3>
            ...
            <div class="card-body no-padding">
              <div class="mailbox-read-info">
                ...
                <h5>Sender: {{$messages[0]->from_user}}, Receipient: {{$messages[0]->to_user}}
                  <span class="mailbox-read-time pull-right">{{$messages[0]->created_at}}</span></h5>
              </div>
            ...
            <div class="card-footer">
              <div class="float-right">
                <a href="{{url('admin/messages/reply/'.$messages[0]->id)}}" class="btn btn-default"><i class="fa fa-reply"></i> Reply</a>
               
              </div>
              <a href="#" onclick="deleteMessage('{{$messages[0]->id}}')" class="btn btn-default"><i class="fa fa-trash-o"></i> Delete</a>
