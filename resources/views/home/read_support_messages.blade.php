          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-body no-padding">
              <div class="mailbox-read-info">
                <h3>{{$supports[0]->subject}}</h3>
                <h5>From: {{$supports[0]->email}}
                  <span class="mailbox-read-time pull-right">{{$supports[0]->created_at}}</span></h5>
              </div>
              <!-- /.mailbox-read-info -->
            ...
            <div class="card-footer">
              <div class="float-right">
                <a href="{{url('admin/support/reply/'.$supports[0]->id)}}" class="btn btn-default"><i class="fa fa-reply"></i> Reply</a>
               
              </div>
              <a href="#" onclick="DeleteContactMessage('{{$supports[0]->id}}')" class="btn btn-default"><i class="fa fa-trash-o"></i> Delete</a>
