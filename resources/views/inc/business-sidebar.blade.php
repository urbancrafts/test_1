      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        <!-- Add icons to the links using the .nav-icon class
          ...
          <li class="nav-item">
            ...
            <a class="nav-link {{ request()->is('auth/business/business_verification_form*') ? 'active' : '' }}" href="{{ url('auth/business/business_verification_form') }}">
              <i class="nav-icon fas fa-chart-pie"></i> <span>Business Verification</span>
