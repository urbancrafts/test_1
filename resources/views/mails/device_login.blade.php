...
<small>Click Yes if you're the one and No if you're not, on the link below.</small>
<a href="{{ url('/device_detection/'.$user_id.'/yes') }}" class="decision-link">Yes</a> &nbsp;|&nbsp;<a href="{{ url('/device_detection/'.$user_id.'/no') }}" class="decision-link">No</a>
</td>
</tr>
...
<br>All rigth reserved to <b>{{$site_name}}</b>. <br>
&copy; {{$site_name.'. '.date("Y")}}</td>
</tr></table></div></div>
</td>
