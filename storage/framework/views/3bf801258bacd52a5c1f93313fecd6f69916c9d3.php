              ...
              <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2" name="receipient[]" id="receipient" multiple="multiple" data-placeholder="Send to"
                            style="width: 100%;">
                        <option value="<?php echo e($messages[0]->from_user); ?>" selected><?php echo e($messages[0]->from_user); ?></option>
                ...
                <div class="form-group">
                  <input class="form-control" name="subject" id="subject" placeholder="Subject:" value="Reply: <?php echo e($messages[0]->subject); ?>">
                </div>
                <div class="form-group">
                      <textarea id="compose-textarea" name="message" class="form-control" style="height: 300px">
                        <?php echo e($messages[0]->msg); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\beach_comber\resources\views/home/reply_message.blade.php ENDPATH**/ ?>