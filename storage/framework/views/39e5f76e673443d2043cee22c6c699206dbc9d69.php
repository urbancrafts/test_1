  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-xs-12">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title"><?php echo e($resorts[0]->name); ?> Bookings</h3>  
          </div>
          <!-- /.box-header -->
          <div class="card-body">
...
<script>
  ...
  ******************************************/
  ...
  dp.onTimeRangeSelected = async (args) => {
      ...
      const resort_id = "<?php echo e($resorts[0]->shelter_id); ?>";
  ...
  async function loadResort() {
        const resort_id = "<?php echo e($resorts[0]->id); ?>";
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\beach_comber\resources\views/home/resort_booking.blade.php ENDPATH**/ ?>