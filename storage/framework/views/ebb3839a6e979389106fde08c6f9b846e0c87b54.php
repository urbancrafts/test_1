    ...
    <section class="content">
      <div class="row">
        <div class="col-md-3">
            ...
            <a href="<?php echo e(url('admin/new_message')); ?>" class="btn btn-primary btn-block mb-3">Compose</a>
          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-body no-padding">
              <div class="mailbox-read-info">
                <h3><?php echo e($messages[0]->subject); ?></h3>
                <h5>Sender: <?php echo e($messages[0]->from_user); ?>, Receipient: <?php echo e($messages[0]->to_user); ?>

                  <span class="mailbox-read-time pull-right"><?php echo e($messages[0]->created_at); ?></span></h5>
              </div>
              
              <!-- /.mailbox-controls -->
              <div class="mailbox-read-message">
                <?php echo $messages[0]->msg; ?>
            ...
            <div class="card-footer">
              <div class="float-right">
                <a href="<?php echo e(url('admin/messages/reply/'.$messages[0]->id)); ?>" class="btn btn-default"><i class="fa fa-reply"></i> Reply</a>
               
              </div>
              <a href="#" onclick="deleteMessage('<?php echo e($messages[0]->id); ?>')" class="btn btn-default"><i class="fa fa-trash-o"></i> Delete</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\beach_comber\resources\views/home/read-message.blade.php ENDPATH**/ ?>