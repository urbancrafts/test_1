...
<div class="content-wrapper">
 ...
 <section class="content">
    ...
    <div class="col-xs-12">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title"><?php echo e($services[0]->title); ?> Booked List</h3> 
        </div>
        <!-- /.box-header -->
        <div class="card-body">
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tr>
              ...
              <td><?php echo e($booking->phone); ?>

              </td>
              <td><?php echo e($booking->type); ?></td>
              <td><?php echo e($booking->booked_date); ?></td>
              <td><?php echo e($booking->duration); ?> / hours</td>
              <td><?php echo e($booking->member); ?></td>
              <td><?php echo e($booking->curr); ?><?php echo e($booking->price); ?></td>
              
              <td><?php if($booking->approved == 1): ?>
                  yes
                <?php else: ?>
                no
                
                <a href="#" onclick="updateBooking('<?php echo e($booking->id); ?>')" class="btn btn-special" title="Set Resort/Room Availability To (Booked) By Updating This Reservation">Update</a>
                
              <?php endif; ?>
            |
            <a href="<?php echo e(url('admin/service_booking/'.$booking->id)); ?>" class="btn btn-special" title="View this reservation"><i class="fa fa-eye"></i>View</a>
            </td>
            </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\beach_comber\resources\views/home/service_booking_form.blade.php ENDPATH**/ ?>