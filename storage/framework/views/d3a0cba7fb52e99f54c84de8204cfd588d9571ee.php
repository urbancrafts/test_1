...
<div class="wrapper">   
  ...
  <li class="nav-item">
    <a class="nav-link active" href="<?php echo e(url('admin/resort_manager/edit_resort_features/'.$resorts2[0]->id)); ?>">Features</a>
  </li>
  <li class="nav-item">
  ...
  <!-- <li class="nav-item">
   ...
   -->
          ...
          <form id="feature-form" method="post" action="<?php echo e(action('App\Http\Controllers\ResortController@update_resort_features')); ?>">
            <input hidden name="resort" value="<?php echo e($resorts2[0]->id); ?>" />
            <div class="form-group">
              <fieldset class="resort-features">
                <legend>Resort features</legend>
                <?php if(count($admin_features) > 0): ?>


                <?php $__currentLoopData = $admin_features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $admin_feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                              
                <label><input type="checkbox" name="feature[]" id="feature" class="minimal" value="<?php echo e($admin_feature->feature); ?>" /> <?php echo e($admin_feature->feature); ?></label> |   
                ...
                <?php $__currentLoopData = $feature_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $features): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                <label id="feature_elem_<?php echo e($key); ?>"><?php echo e($features); ?><a href="#" class="fas fa-trash" onclick="removeFeatures('<?php echo e($resorts2[0]->id); ?>','<?php echo e($key); ?>')" title="Delete <?php echo e($features); ?>"></a></label>        
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php endif; ?>
                <?php endif; ?>
              </fieldset>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\SONY\Desktop\beach_comber\resources\views/home/edit_resort_features.blade.php ENDPATH**/ ?>