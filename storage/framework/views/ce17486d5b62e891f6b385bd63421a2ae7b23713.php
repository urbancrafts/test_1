...
$('form#update-service-form').on('submit', function(e){
e.preventDefault();
...
if($.trim($('#name').val()) == ""){
  ...
  $('#price').css('border', 'solid 1px red');
  $('.service-price-error').show();
  $('.service-price-error').html('*Price field can only accept numbers');  
      ...
      'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
         ...
         success:function(data){
            if(data.success == true){
             ...
             $("#sendEmail").prop('disabled', false);
             $('#sendEmail').html("Submit");
             window.location = "<?php echo e(url('')); ?>/admin/service_manager/edit_service_img/"+service;
  ...
  <li class="nav-item">
    <a class="nav-link active" href="<?php echo e(url('admin/service_manager/edit_service/'.$services[0]->id)); ?>">Edit form</a>
  </li>
  <li class="nav-item">
        ...
        <section class="col-lg-7 connectedSortable" id="blog-body">
            ...
            <div class="card card-info">
                <div class="card-header">
                  ...
                  <h3 class="card-title"><i class="fa fa-server"></i> <?php echo e($services[0]->title); ?></h3>
                  <!-- tools box -->
                ...
                <div class="card-body">
                  <form id="update-service-form" action="<?php echo e(action('App\Http\Controllers\ServiceController@update_service')); ?>" method="post" enctype="multipart/form-data">
                    <input type='hidden' id='uid' name='uid' value='<?php echo e(Auth::user()->id); ?>' />
                   <input type='hidden' id='service' name='service' value='<?php echo e($services[0]->id); ?>' />
                    
                   <div class="form-group">
                    <label>Category:</label>
                   <input type="text" class="form-control" id="category" name="category" value="<?php echo e($services[0]->category); ?>" disabled>
                   </div>
                   <div class="form-group">
                    <label>Name:</label>
                        <span style="color: red;" class="service-name-error">*</span>
                      <input type="text" class="form-control" id="name" name="name" onfocus="elementFocus(this.id, 'service-name-error')" placeholder="Enter Service Name/Business Name" value="<?php echo e($services[0]->title); ?>">
                    </div>
                    ...
                    <div class="form-group">
                      <label>Price/hour:</label>
                        ...
                        <input type="number" class="form-control" id="price" name="price" onfocus="elementFocus(this.id, 'service-price-error')" placeholder="price" value="<?php echo e($services[0]->price); ?>">
                      </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control pac-target-input valid" id="location" name="location" onfocus="elementFocus(this.id, 'service-location-error')"  value="<?php echo e($services[0]->location); ?>" data-validation="required" placeholder="Enter a location" autocomplete="off">
                      ...
                      <div class="form-group">
                        ...
                        <input type="url" class="form-control pac-target-input valid" id="youtube" name="youtube" value="<?php echo e($services[0]->youtube); ?>" placeholder="Enter youtube video link" autocomplete="off">
                    ...
                    <div class="form-group">
                      <label>Service Address:</label>
                        <span style="color: red; display: none" class="service-address-error">(*Required)</span>
                      <textarea id="address" name="address" placeholder="Service address"
                                style="width: 100%; height: 70px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo e($services[0]->address); ?></textarea>
                    </div>
                      </div>
                    ...
                    <textarea id="desc" name="desc" placeholder="Enter description"
                                style="width: 100%; height: 70px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo e($services[0]->about); ?></textarea>
                    </div>
                      </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\beach_comber\resources\views/home/edit_service.blade.php ENDPATH**/ ?>