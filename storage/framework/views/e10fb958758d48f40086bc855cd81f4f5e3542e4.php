      ...
      'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
         ...
         success:function(data){
            if(data.success == true){
             ...
             $("#sendEmail").prop('disabled', false);
             $('#sendEmail').html("Submit");
             window.location = "<?php echo e(url('')); ?>/admin/service_manager/edit_service_img/"+data.data.id;
            //location.reload();
      ...
      <div class="row">
       ...
       <?php if(Auth::user()->user_type == "admin"): ?>
          <div class="card card-info">
            ...
            <div class="card-body">
              <form id="service_category_form" action="<?php echo e(action('App\Http\Controllers\ServiceController@create_categories')); ?>" method="post" enctype="multipart/form-data">
        ...
        <label><?php echo e($category->category); ?><a href="#" class="fas fa-trash" onclick="deleteCategory('<?php echo e($category->id); ?>','<?php echo e($category->category); ?>')" title="Delete <?php echo e($category->category); ?>"></a></label>       
          ...
          <?php endif; ?>
            ...
            <div class="card card-info">
                ...
                <div class="card-body">
                  <form id="new-service-form" action="<?php echo e(action('App\Http\Controllers\ServiceController@create_new_service')); ?>" method="post" enctype="multipart/form-data">
                 ...
                 <tr class="item" >
                  ...
                  <div class="product-info">
                    ...
                    <span class="product-description">
                        ...
                        <a href="<?php echo e(url('admin/shop_manager/orders/'.$shop->id)); ?>" class="fa fa-book book-btn" title="Check <?php echo e($shop->item_name); ?> orders">Orders</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\beach_comber\resources\views/home/store.blade.php ENDPATH**/ ?>