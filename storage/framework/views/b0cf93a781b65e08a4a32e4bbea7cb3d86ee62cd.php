...
<?php echo $__env->make('auth.sign-in', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<form id="news-letter-form" action="<?php echo e(action('App\Http\Controllers\AjaxRequestController@news_letter_sub')); ?>" class="mc4wp-form mc4wp-form-293" method="post" data-id="293" data-name="Foxuries Mailchimp"><div class="mc4wp-form-fields">
  ...
  <div class="elementor-image">
    ...
    <div class="container social_feeds">
      ...
      <div class="pull-right facebook_feeds"><div class="fb-like-box" data-href="<?php echo e($settings[0]->facebook); ?>" data-width="400" data-height="500" data-colorscheme="light" data-show-faces="true" data-header="true" data-stream="true" data-show-border="true"></div></div>
      <span class="clearfix"></span>
      </div><div class="container bt_sec">
<div class="pull-left copyrite">
<span class="glyphicon glyphicon-copyright-mark"></span> <?php echo e($settings[0]->site_name); ?> &reg; <?php echo date('Y');?></div>
...
<span class="clearfix"></span>
  ...
  <div class="elementor-widget-container">
  <div class="elementor-text-editor elementor-clearfix"><?php echo e($settings[0]->address); ?></div>
  </div>
  </div>
  </div>
  </div>
  ...
  <div class="elementor-widget-container">
  <div class="elementor-text-editor elementor-clearfix">Copyright © <?php echo date('Y'); ?>. All Rights Reserved <?php echo e($settings[0]->site_name); ?>.</div>
  </div>
  </div>
  </div>
  </div>
...
<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-608 <?php echo e(request()->is('*/') ? 'current-menu-item' : ''); ?>">
<a href="<?php echo e(url('/')); ?>">Home</a>
  </li>

  <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-608 <?php echo e(request()->is('resorts*') ? 'current-menu-item' : ''); ?>">
    <a href="<?php echo e(url('/resorts')); ?>">Resorts</a></li>
    
    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-608 <?php echo e(request()->is('boats*') ? 'current-menu-item' : ''); ?>">
      <a href="<?php echo e(url('/boats')); ?>">Boats</a></li>
      
      <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-608 <?php echo e(request()->is('services*') ? 'current-menu-item' : ''); ?>">
        <a href="<?php echo e(url('/services')); ?>">Services</a></li>

    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-608 <?php echo e(request()->is('shop*') ? 'current-menu-item' : ''); ?>">
        <a href="<?php echo e(url('/shop')); ?>">Shop</a></li>

        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home page_item page-item-73 current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-has-children menu-item-120 <?php echo e(request()->is('pages*') ? 'current-menu-item' : ''); ?>">
          <a href="#">Pages</a>
          <ul class="sub-menu">
            <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-557 <?php echo e(request()->is('pages/about_us') ? 'current-menu-item' : ''); ?>">
              <a href="<?php echo e(url('pages/about_us')); ?>">About Us</a></li>
              <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-557 <?php echo e(request()->is('pages/blogs*') ? 'current-menu-item' : ''); ?>">
                <a href="<?php echo e(url('pages/blogs')); ?>">Blogs</a></li>
              <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-557 <?php echo e(request()->is('pages/contact') ? 'current-menu-item' : ''); ?>">
                <a href="<?php echo e(url('pages/contact')); ?>">Contact Us</a></li>
          </ul>
        </li>
  ...
  <link data-minify="1" rel="stylesheet" property="stylesheet" id="rs-icon-set-fa-icon-css" href="<?php echo e(asset('wp-content/cache/min/1/foxuries/wp-content/plugins/revslider/public/assets/fonts/font-awesome/css/font-awesome-0dcb085a38fb6e51ece3d95f068d1109.css')); ?>" type="text/css" media="all" />
  <script src="<?php echo e(asset('modal/modal/js/bootstrap.min.js')); ?>"></script>
<!-- meanmenu JS
    ============================================ -->

<script src="<?php echo e(asset('modal/modal/js/modal-active.js')); ?>"></script>
  ...
  <script type='text/javascript'>
  var elementorFrontendConfig = {"environmentMode":{"edit":false,"wpPreview":false},"i18n":{"shareOnFacebook":"Share on Facebook","shareOnTwitter":"Share on Twitter","pinIt":"Pin it","downloadImage":"Download image"},"is_rtl":false,"breakpoints":{"xs":0,"sm":480,"md":768,"lg":1025,"xl":1440,"xxl":1600},"version":"2.9.9","urls":{"assets":"<?php echo e(asset('/')); ?>"},"settings":{"page":[],"general":{"elementor_stretched_section_container":"body","elementor_global_image_lightbox":"yes","elementor_lightbox_enable_counter":"yes","elementor_lightbox_enable_fullscreen":"yes","elementor_lightbox_enable_zoom":"yes","elementor_lightbox_enable_share":"yes","elementor_lightbox_title_src":"title","elementor_lightbox_description_src":"description"},"editorPreferences":[]},"post":{"id":73,"title":"<?php echo e(config('app.name', 'Laravel')); ?>","excerpt":"","featuredImage":false}};
  </script>
  

  
  <?php /**PATH C:\Users\SONY\Desktop\beach_comber\resources\views/inc/footer1.blade.php ENDPATH**/ ?>