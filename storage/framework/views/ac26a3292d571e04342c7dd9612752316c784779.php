...
if($.trim($(this).val()) == "" ){
  ...
  window.location = "<?php echo e(url('admin/content_manager/edit_contents')); ?>?cnt_name="+$(this).val();
}
});
        ...
        <section class="col-lg-12 connectedSortable" id="blog-body">
          ...
          <div class="card card-info">
            <div class="card-header">
              ...
              <h3 class="card-title"><i class="fa fa-edit"></i> Create Content Name</h3>
              <!-- tools box -->
            ...
            <div class="card-body">
              <form id="cnt-name-form" action="<?php echo e(action('App\Http\Controllers\AjaxRequestController@create_content_name')); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="card card-info">
                <div class="card-header">
                  ...
                  <h3 class="card-title"> <i class="fa fa-edit"></i> Update Contents</h3>
                  <!-- tools box -->
                  <div class="float-right card-tools">
                    <button type="button" class="btn btn-tool" data-card-widget="collapse">
                      <i class="fas fa-minus"></i>
                ...
                <div class="card-body">
                  <form id="content-form" action="<?php echo e(action('App\Http\Controllers\AjaxRequestController@update_content')); ?>" method="post" enctype="multipart/form-data">
                   
                    <?php if(isset($_GET['cnt_name'])): ?>
                           
                           <?php $__currentLoopData = $contents2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $content): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                           <input type="hidden" id="cnt-id" name="cnt-id" value="<?php echo e($content->id); ?>" />   
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\beach_comber\resources\views/home/content.blade.php ENDPATH**/ ?>