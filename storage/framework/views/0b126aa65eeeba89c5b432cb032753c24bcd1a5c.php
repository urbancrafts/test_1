...
if(str == true){
  $.ajax({
      ...
      'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
         ...
         type: "POST",
         dataType: "json",
         url: "<?php echo e(action('App\Http\Controllers\ResortController@remove_resort_room_img')); ?>",
         data: {'room': room, 'key_num': key}, 
         beforeSend:function(){
             //$(".blog-alert-success1").show();
             //$('.blog-alert-danger1').hide();
             //$(".blog-alert-success1").html("<div class='load'>Loading...</div>");
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="col-md-12 grid-margin">
          ...
          <div class="tabSide">
            <div class="card card-body p-0" style="border: 2px solid #E51924; border-radius: 0px">
              ...
              <ul class="nav nav-pills nav-justified">
                <li class="nav-item">
                  <a class="nav-link " href="<?php echo e(url('admin/resort_manager/room/'.$rooms[0]->shelter_id.'/'.$rooms[0]->id)); ?>">Edit form</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link active" href="<?php echo e(url('admin/resort_manager/edit_room_img/'.$rooms[0]->shelter_id.'/'.$rooms[0]->id)); ?>">Images</a>
                </li>
                <li class="nav-item">
          ...
          <form id="img-form" method="post" action="<?php echo e(action('App\Http\Controllers\ResortController@update_resort_room_img')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="row firstBankDel mt-4" id="first_bank">
                <div class="col-xl-4">
                 ...
                 <?php if($rooms[0]->images): ?>
                  <?php $__currentLoopData = $roomImg; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $pimg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      ...
                      <div class="card mb-0">
                          <div class="card-header">
                              <div class="d-flex justify-content-between">
                                  ...
                                  <div>
                                      <button onclick="removeImg('<?php echo e($rooms[0]->id); ?>', '<?php echo e($key); ?>')" class="btn btn-danger btn-sm" type="button"><i class="fa fa-trash"></i></button>
                                  </div>
                              </div>
            ...
            <a href="<?php echo e(url('admin/resort_manager/book_room/'.$rooms[0]->shelter_id.'/'.$rooms[0]->id)); ?>" class="btn btn-primary rounded-0 pt-3 pb-3" type="submit">SAVE AND CONTINUE</a>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\SONY\Desktop\beach_comber\resources\views/home/edit_room_img.blade.php ENDPATH**/ ?>