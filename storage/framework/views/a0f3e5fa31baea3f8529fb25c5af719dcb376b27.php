...
<div class="foxuries-shop foxuries-breadcrumb">
    ...
    <div class="hb_room_gallery" id="hb_single_room_gallery">
      ...
      <?php if($shops[0]->images): ?>
        <?php $__currentLoopData = $shopImg; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $pimg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="inner">
...
<?php echo $__env->make('layouts.app1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\beach_comber\resources\views/pages/shop_single.blade.php ENDPATH**/ ?>