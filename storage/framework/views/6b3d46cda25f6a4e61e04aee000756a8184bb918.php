...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Booking Table
        <small> <?php echo e($rooms[0]->room_no); ?></small>
      </h1>
  ...
  <div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="tabSide">
          <div class="card card-body p-0" style="border: 2px solid #E51924; border-radius: 0px">
            ...
            <ul class="nav nav-pills nav-justified">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="<?php echo e(url('admin/resort_manager/book_room/'.$rooms[0]->shelter_id.'/'.$rooms[0]->id)); ?>">Bookings</a>
              </li>
              <li class="nav-item">
      ...
      <div class="col-xs-12">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Resort Reservations</h3>  
          </div>
          <!-- /.box-header -->
          <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tr>
                ...
                <td><?php echo e($reservation->phone); ?>

                </td>
                <td><?php echo e($reservation->type); ?></td>
                <td><?php echo e($reservation->member); ?></td>
                <td><?php echo e($reservation->curr); ?><?php echo e($reservation->price); ?></td>
                <td><?php echo e($reservation->checkin); ?></td>
                
                <td><?php echo e($reservation->checkout); ?></td>
                <td><?php if($reservation->approved == 1): ?>
                    yes
                  <?php else: ?>
                  no
                  
                  <a href="#" onclick="updateReservation('<?php echo e($reservation->id); ?>')" class="btn btn-special" title="Set Resort/Room Availability To (Booked) By Updating This Reservation">Update</a>
                  
                <?php endif; ?>
              |
              <a href="<?php echo e(url('admin/reservation/'.$reservation->id)); ?>" class="btn btn-special" title="View this reservation"><i class="fa fa-eye"></i>View</a>
              </td>
              </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\SONY\Desktop\beach_comber\resources\views/home/room_booking.blade.php ENDPATH**/ ?>