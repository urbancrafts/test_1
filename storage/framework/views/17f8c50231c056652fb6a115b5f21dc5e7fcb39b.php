...
$(document).ready(function(){
  ...
  $(function () {
       ...
       $total_record = <?php echo e(count($users)); ?>;
			 $record_per_page = 9;
  ...
  function loadHomeBlog($record_per_page, $start){
    ...
    $action = "loadHomeBlogs";
			...
			'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
				 ...
				 type: "POST",
			   dataType: "json",
			   url: "<?php echo e(action('App\Http\Controllers\AjaxRequestController@load_home_blog')); ?>",
			   data: {"record_per_page": $record_per_page, "start": $start, "action": $action},
			   beforeSend:function(){
				   $("#load-home-blog").append("<div class='load'><img src='<?php echo e(asset('loaders/loader.gif')); ?>'/ > Loading...</div>");
			   },
			   complete:function(){
				   $(".load").remove();
			   },
			   error:function(){
			   $("#load-home-blog").append("<div class='errLoading'><img src='<?php echo e(asset('icons/ic_connections.png')); ?>'/ > Please check your internet connection</div>");
			   },
...
<!-- /.content-header -->
    ...
    <section class="content">
      ...
      <?php if($myselfs[0]->user_type == "member" && $myselfs[0]->dues == 0): ?>
          
      <div class="alert alert-info alert-dismissible">
        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
        <h4><i class="icon fa fa-info"></i> Alert!</h4>
        <?php echo e(Auth::user()->name); ?>, pay your membership fee to become an active member on this platform, to do so click <a href="<?php echo e(url('admin/member_subscription')); ?>">subscribe</a>.
      </div>
      ...
      <div class="row">
        <div class="col-lg-3 col-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3><?php echo e(count($reservations) + count($bookings)); ?></h3>
            ...
            <a href="<?php echo e(url('admin/reservations')); ?>" class="small-box-footer">See info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-6">
          ...
          <div class="small-box bg-green">
            ...
            <a href="<?php echo e(url('admin/shop_orders')); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3><?php echo e(count($transactions)); ?></h3>
            ...
            <a href="<?php echo e(url('admin/transactions')); ?>" class="small-box-footer">See info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <h3><?php echo e(count($visited)); ?></h3>
            ...
            <a href="<?php echo e(url('admin/site_visitors')); ?>" class="small-box-footer">See info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div>
      ...
      <div class="row">
        ...
        <section class="col-lg-7 connectedSortable" id="blog-body">
            ...
            <div class="card card-info">
                ...
                <div class="card-body">
                  <form id="blog-form" action="<?php echo e(action('App\Http\Controllers\AjaxRequestController@make_blog_post')); ?>" method="post" enctype="multipart/form-data">
                   <input type="hidden" id="uid" name="uid" value="<?php echo e(Auth::user()->id); ?>" />
                   <input type="hidden" id="poster-name" name="poster-name" value="<?php echo e(Auth::user()->name); ?>" />
        ...
        <div class="col-md-4">
          ...
          <div class="card card-primary card-outline">
            <div class="card-header with-border">
              ...
              <div class="card-tools float-right">
                <span class="badge badge-danger"><?php echo e(count($members)); ?> New Members</span>
                <button type="button" class="btn btn-tool" data-card-widget="collapse">
                  <i class="fas fa-minus"></i>
                </button>
                <button type="button" class="btn btn-tool" data-card-widget="remove">
            ...
            <div class="card-body no-padding">
              <ul class="users-list clearfix">
                ...
                <li>
                  <?php if($member->img != ""): ?>
                  <img src="<?php echo e(asset('storage/img/users/'.$member->id.'/profile/'.$member->img)); ?>" alt="<?php echo e($member->name); ?>">
                       
                   <?php else: ?>
                   <img src="<?php echo e(asset('storage/img/users/default.png')); ?>" alt="<?php echo e($member->name); ?>">   
                   <?php endif; ?>
                  
                  
                  <a class="users-list-name" href="<?php echo e(url('users/profile/'.$member->id)); ?>"><?php echo e($member->name); ?></a>
                  <span class="users-list-date"><?php echo e($member->create_at); ?></span>
                </li> 
          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-body">
             ...
             <li class="item">
              ...
              <div class="product-info">
                ...
                <a href="<?php echo e(url('resorts')); ?>" class="product-title">Resort Reservation
                </a>
            ...
            <li class="item">
              <div class="product-info">
            <a href="<?php echo e(url('boat')); ?>" class="product-title">Boat Booking
            </a>
          </div>
        </li>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\SONY\Desktop\beach_comber\resources\views/home/member_dashboard.blade.php ENDPATH**/ ?>