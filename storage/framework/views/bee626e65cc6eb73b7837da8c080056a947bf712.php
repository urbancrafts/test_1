...
function createTransactionRecord(trn_type,trn_id,ref_id,gateway,name,email,phone,user_id,curr,amount,status,msg){
                    var type = "<?php echo e($bookings[0]->type); ?>";
                    var room = "<?php echo e($bookings[0]->room_id); ?>";
                    var resort = "<?php echo e($bookings[0]->shelter_id); ?>";
                     jQuery.ajax({
                     headers: {
                    'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')
                    },
                      type:"POST",
                      url: "<?php echo e(action('App\Http\Controllers\AjaxRequestController@create_transaction_record')); ?>",
                      dataType: "json",
                      ...
                      success:function(data){
                          if(data.success == true){
                              if(type == "room"){
                                window.location = "<?php echo e(url('resorts/resort')); ?>/"+resort+"/"+room+"#hb_single_room_gallery"; 
                              }else if(type == "resort"){
                                window.location = "<?php echo e(url('resorts/resort')); ?>/"+resort+"#hb_single_room_gallery"; 
                              }
...
function payWithPaystack(){
    var handler = PaystackPop.setup({
      ...
      email: "<?php echo e($bookings[0]->email); ?>",
      amount: <?php echo e($bookings[0]->price); ?> * 100,
         ...
         custom_fields: [
            {
                ...
                value: "+234<?php echo e($bookings[0]->phone); ?>"
            }
         ]
      },
      callback: function(response){
          
          createTransactionRecord('<?php echo e($bookings[0]->type); ?>','<?php echo e($bookings[0]->id); ?>',response.reference,'paystack','<?php echo e($bookings[0]->name); ?>','<?php echo e($bookings[0]->email); ?>','<?php echo e($bookings[0]->phone); ?>','<?php echo e($bookings[0]->user_id); ?>','<?php echo e($bookings[0]->curr); ?>','<?php echo e($bookings[0]->price); ?>','success','test transaction');
            ...
            <div class="card-payment paystack">
             ...
             <div id="paymentSection">
                <form class="adminpro-form">
                    <?php if($bookings[0]->type == 'room'): ?> 
                    <h4>Room: <?php echo e($rooms[0]->room_no); ?></h4>
                     <?php else: ?>
                     <h4>Resort: <?php echo e($resorts[0]->name); ?></h4>
                    <?php endif; ?>
                    
              <h4><?php echo e($bookings[0]->curr); ?><?php echo e($bookings[0]->price); ?> /
              <?php echo e($bookings[0]->checkin); ?> - <?php echo e($bookings[0]->checkout); ?>
              ...
              <?php echo e($bookings[0]->checkin); ?> - <?php echo e($bookings[0]->checkout); ?>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <input type="hidden" value="<?php echo e($bookings[0]->id); ?>" name="booking_id" id="booking_id" />
                                <?php if($bookings[0]->type == "room"): ?>
                                <input type="hidden" value="<?php echo e($bookings[0]->room_id); ?>" name="room_id" id="room_id" /> 
                                <input type="hidden" value="room" name="type" id="type" />
                                <input type="hidden" value="<?php echo e($rooms[0]->room_no); ?>" name="service_name" id="service_name" />
                                <?php else: ?>
                                <input type="hidden" value="<?php echo e($bookings[0]->shelter_id); ?>" name="resort_id" id="resort_id" /> 
                                <input type="hidden" value="resort" name="type" id="type" />
                                <input type="hidden" value="<?php echo e($resorts[0]->name); ?>" name="service_name" id="service_name" />
                                <?php endif; ?>
                                
                                <input type="hidden" value="<?php echo e($bookings[0]->curr); ?>" name="curr" id="curr" />
                                <input type="hidden" value="<?php echo e($bookings[0]->price); ?>" name="amount" id="amount" />
...
<?php echo $__env->make('layouts.app1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\beach_comber\resources\views/pages/reservation_payment.blade.php ENDPATH**/ ?>