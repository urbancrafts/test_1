                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="basic-login-inner modal-basic-inner">
                                ...
                                <form id="recover-form" action="<?php echo e(action('App\Http\Controllers\API\RegisterController@forgot_password')); ?>" method="POST" style="display: none">
                            ...
                            <form id="otp-form" action="<?php echo e(action('App\Http\Controllers\API\RegisterController@verify_email_code')); ?>" method="post" class="wpcf7-form init"  style="display: none">
