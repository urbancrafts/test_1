              ...
              <div class="card-body">
               ...
               <tr class="item" >
                ...
                <div class="product-img">
                  <img src="<?php echo e(asset('storage/img/resorts/'.$resort->id.'/images/'.$resort->img_1)); ?>" alt="<?php echo e($resort->name); ?>">
                </div>
                <div class="product-info">
                  ...
                  <span class="product-description">
                      ...
                      <a href="<?php echo e(url('admin/resort/'.$resort->id)); ?>" class="fa fa-edit edit-btn" title="Edit <?php echo e($resort->name); ?>">Edit</a> | 
                      <a href="<?php echo e(url('admin/book_resort/'.$resort->id)); ?>" class="fa fa-book book-btn" title="Book <?php echo e($resort->name); ?>">Booking</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\beach_comber\resources\views/home/boat_services.blade.php ENDPATH**/ ?>