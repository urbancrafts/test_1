...
if(str == true){
  $.ajax({
      ...
      'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
         ...
         type: "POST",
         dataType: "json",
         url: "<?php echo e(action('App\Http\Controllers\ShopController@remove_product_img')); ?>",
...
<div class="wrapper">   
          ...
          <div class="tabSide">
            <div class="card card-body p-0" style="border: 2px solid #E51924; border-radius: 0px">
                <ul class="nav nav-pills nav-justified">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active" href="<?php echo e(url('admin/shop_manager/edit_shop_img/'.$shops[0]->id)); ?>">Images</a>
                  </li>
                  <li class="nav-item">
  ...
  <!-- <li class="nav-item">
   ...
   -->
          ...
          <form id="img-form" method="post" action="<?php echo e(action('App\Http\Controllers\ShopController@update_product_img')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="shop" id="shop" value="<?php echo e($shops[0]->id); ?>">
            ...
            <div class="row firstBankDel mt-4" id="first_bank">
                <div class="col-xl-4">
                 ...
                 <?php if($shops[0]->images): ?>
                  <?php $__currentLoopData = $shopImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $pimg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      ...
                      <div class="card mb-0">
                          <div class="card-header">
                              <div class="d-flex justify-content-between">
                                  ...
                                  <div>
                                      <button onclick="removeImg('<?php echo e($shops[0]->id); ?>', '<?php echo e($key); ?>')" class="btn btn-danger btn-sm" type="button"><i class="fa fa-trash"></i></button>
                                  </div>
                              </div>
            ...
            <a href="<?php echo e(url('admin/shop_manager/edit_discount_settings/'.$shops[0]->id)); ?>" class="btn btn-primary rounded-0 pt-3 pb-3" type="submit">SAVE AND CONTINUE</a>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\beach_comber\resources\views/home/edit_shop_img.blade.php ENDPATH**/ ?>