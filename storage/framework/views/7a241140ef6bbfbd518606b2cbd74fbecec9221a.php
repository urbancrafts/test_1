...
function createTransactionRecord(trn_type,trn_id,service,ref_id,gateway,name,email,phone,user_id,curr,amount,status,msg){
                     jQuery.ajax({
                     headers: {
                    'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')
                      ...
                      success:function(data){
                          if(data.success == true){
                           window.location = "<?php echo e(url('service')); ?>/"+service+"#hb_single_room_gallery"; 
                          }else{
...
function payWithPaystack(){
    var handler = PaystackPop.setup({
      ...
      callback: function(response){
          ...
          createTransactionRecord('<?php echo e($bookings[0]->type); ?>','<?php echo e($bookings[0]->id); ?>','<?php echo e($bookings[0]->service_id); ?>',response.reference,'paystack','<?php echo e($bookings[0]->name); ?>','<?php echo e($bookings[0]->email); ?>','<?php echo e($bookings[0]->phone); ?>','<?php echo e($bookings[0]->user_id); ?>','<?php echo e($bookings[0]->curr); ?>','<?php echo e($bookings[0]->price); ?>','success','test transaction');
            ...
            <div class="card-payment paystack">
             ...
             <div id="paymentSection">
                <form class="adminpro-form">
                    <h4>Service: <?php echo e($services[0]->title); ?></h4>
              <h4><?php echo e($bookings[0]->curr); ?><?php echo e($bookings[0]->price); ?> / <?php if($bookings[0]->duration > 1): ?>
                <?php echo e($bookings[0]->duration); ?> hours
              <?php else: ?>
              <?php echo e($bookings[0]->duration); ?> hour 
              <?php endif; ?></h4>
                    ...
                    <div class="row">
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <input type="hidden" value="<?php echo e($bookings[0]->service_id); ?>" name="service_id" id="service_id" />
                                ...
                                <input type="hidden" value="<?php echo e($services[0]->title); ?>" name="service_name" id="service_name" />
...
<?php echo $__env->make('layouts.app1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\beach_comber\resources\views/pages/service_payment.blade.php ENDPATH**/ ?>