...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Booking Table
        <small><?php echo e($boats[0]->title); ?></small>
      </h1>
        ...
        <div class="tabSide">
          <div class="card card-body p-0" style="border: 2px solid #E51924; border-radius: 0px">
            ...
            <ul class="nav nav-pills nav-justified">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="<?php echo e(url('admin/boat_manager/bookings/'.$boats[0]->id)); ?>">Bookings</a>
              </li>
              <!-- <li class="nav-item">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\beach_comber\resources\views/home/boat_bookings.blade.php ENDPATH**/ ?>