          ...
          jQuery("#shop-category").on("change", function(e){
            ...
            'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')
               ...
               beforeSend:function(){
                   ...
                   jQuery(".alert-success").html("<div class='load'><img src='<?php echo e(asset('loaders/bx_loader.gif')); ?>'/ > Loading...</div>");
               },
               complete:function(){
                   jQuery(".alert").hide();
               },
               ...
               jQuery(".alert-danger").html("<div class='errLoading'><img src='<?php echo e(asset('icons/ic_connections.png')); ?>'/ > Please check your internet connection</div>");
               },
...
<div class="foxuries-shop foxuries-breadcrumb">
    ...
    <div class="single-room-meta">
         ...
         <div class="single-room-price-wrap">
            ...
            <span class="price_value price_min" style="font-size: 36px;"><?php echo e($shops[0]->curr); ?><?php echo e($shops[0]->price); ?></span>
            <span class="unit">
                <?php if($shops[0]->available == 1): ?>
                    Available
                    <?php else: ?>
                  Out of stock
                <?php endif; ?>
    ...
    <?php $__currentLoopData = $shops; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div id="hb_widget_search-2" class="widget widget_hb_widget_search"><span class="gamma widget-title">Order</span>
                ...
                <h3>Order</h3>
                <form name="hb-search-form" id="shop-order-form" action="<?php echo e(action('App\Http\Controllers\AjaxRequestController@post_shop_order')); ?>" >
                <ul class="hb-form-table">
                    <input type="hidden" name="item-id" id="item-id" value="<?php echo e($shop->id); ?>" />
                    <input type="hidden" name="item-name" id="item-name" value="<?php echo e($shop->item_name); ?>" />
                    ...
                    <?php endif; ?>
                    <input type="hidden" name="curr" id="curr" value="<?php echo e($shop->curr); ?>" />
                    <input type="hidden" name="price" id="price" value="<?php echo e($shop->price); ?>" />
                    <li class="hb-form-field">
            ...
            <div id="hb_widget_cart-2" class="widget widget_hb_widget_cart"> 
                ...
                <h3>Out of stock</h3>
                <p class="hb_mini_cart_empty">Sorry, <?php echo e($shop->item_name); ?> is out of stock at the moment</p>
                </div>
                </div>
    ...
    <div class="hb_room_gallery" id="hb_single_room_gallery">
        ...
        <?php if($shop->img_1 != ""): ?>
        <div class="inner">
            <img src="<?php echo e(asset('storage/img/shop/'.$shop->img_1)); ?>" alt="<?php echo e($shop->item_name); ?>">
            </div>  
        <?php endif; ?>

        <?php if($shop->img_2 != ""): ?>
        <div class="inner">
            <img src="<?php echo e(asset('storage/img/shop/'.$shop->img_2)); ?>" alt="<?php echo e($shop->item_name); ?>">
            </div>  
        <?php endif; ?>

        <?php if($shop->img_3 != ""): ?>
        <div class="inner">
            <img src="<?php echo e(asset('storage/img/shop/'.$shop->img_3)); ?>" alt="<?php echo e($shop->item_name); ?>">
            </div>  
        <?php endif; ?>

        <?php if($shop->img_4 != ""): ?>
        <div class="inner">
            <img src="<?php echo e(asset('storage/img/shop/'.$shop->img_4)); ?>" alt="<?php echo e($shop->item_name); ?>">
            </div>  
        <?php endif; ?>
...
<?php echo $__env->make('layouts.app1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\beach_comber\resources\views/pages/shop_order.blade.php ENDPATH**/ ?>