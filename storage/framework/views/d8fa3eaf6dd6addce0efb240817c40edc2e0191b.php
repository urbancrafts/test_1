      ...
      <div class="col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Site Visitors</h3> | <a href="<?php echo e(url('admin/site_activities')); ?>" class="fa fa-line-chart">Activities</a>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <?php $__currentLoopData = $visitors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $visited): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                <td><?php echo e($visited->ip); ?></td>
                <td><?php echo e($visited->mac_address); ?>

                </td>
                
                <td><?php echo e($visited->map); ?></td>
                
                <td><?php echo e($visited->created_at); ?></td>
              </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\beach_comber\resources\views/home/visitors.blade.php ENDPATH**/ ?>