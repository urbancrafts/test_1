      ...
      <?php $__env->startSection('content'); ?>
		<!-- Page loader -->
    <?php if(count($page_banner) > 0): ?>
        <style id='foxuries-style-inline-css' type='text/css'>
        
            div.foxuries-yacht{
              background-image: url(<?php echo e($page_banner[0]->banner); ?>);
            }
            </style>
     <?php else: ?>
     <style id='foxuries-style-inline-css' type='text/css'>
  ...
  jQuery(document).ready(function(){
    ...
    if(jQuery.trim(jQuery(this).val()) == ""){
      ...
      'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')
           ...
           type: "POST",
         dataType: "json",
         url: "<?php echo e(action('App\Http\Controllers\AjaxRequestController@load_boat_category')); ?>",
         data: {"boatCat": jQuery(this).val()},
         beforeSend:function(){
			//jQuery("#search-btn").prop('disabled', true);
			jQuery('#boat-loader').html("<div class='load'><img src='<?php echo e(asset('loaders/AjaxLoader.gif')); ?>' /></div>");
        ...
        //jQuery("#boat-loader").html("");
         ...
         $total_record = <?php echo e(count($boats)); ?>;
         $record_per_page = 9;
    ...
    function loadHomeBlog($record_per_page, $start){
      ...
      jQuery.ajax({
        ...
        'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')
           ...
           type: "POST",
           dataType: "json",
           url: "<?php echo e(action('App\Http\Controllers\AjaxRequestController@load_boat_data')); ?>",
...
<?php echo $__env->make('layouts.app1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\SONY\Desktop\beach_comber\resources\views/pages/boat.blade.php ENDPATH**/ ?>