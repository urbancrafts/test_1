    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-9">
            ...
            <form id="msg-form" action="<?php echo e(action('App\Http\Controllers\AjaxRequestController@reply_contact_msg')); ?>">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2" name="receipient[]" id="receipient" multiple="multiple" data-placeholder="Send to"
                            style="width: 100%;">
                        <option value="<?php echo e($supports[0]->email); ?>" selected><?php echo e($supports[0]->email); ?></option>
                ...
                <div class="form-group">
                  <input class="form-control" name="subject" id="subject" placeholder="Subject:" value="Reply: <?php echo e($supports[0]->subject); ?>">
                </div>
                <div class="form-group">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\beach_comber\resources\views/home/reply_support_message.blade.php ENDPATH**/ ?>