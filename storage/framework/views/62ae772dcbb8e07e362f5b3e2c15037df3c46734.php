...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Admin
        <small>Site Visitor's Activity</small>
      </h1>
      ...
      <div class="col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Visitor Activities</h3> | <a href="<?php echo e(url('admin/site_visitors')); ?>" class="fa fa-eye">Visitors</a>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tr>
                ...
                <td><?php echo e($activity->mac_address); ?>

                </td>
                <td><?php echo e($activity->url); ?>

                </td>
                
                <td><?php echo e($activity->map); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\beach_comber\resources\views/home/activity.blade.php ENDPATH**/ ?>