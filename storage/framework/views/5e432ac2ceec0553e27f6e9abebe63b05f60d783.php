...
<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-73 current_page_item current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-has-children menu-item-120">
<a href="<?php echo e(url('/')); ?>">Home</a>
  ...
  <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-608">
    ...
    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-608">
      <a href="<?php echo e(url('/boat')); ?>">Boats</a></li>

      <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-608">
        <a href="<?php echo e(url('/yacht')); ?>">Yachts</a></li>

    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-608">
        <a href="<?php echo e(url('/shop')); ?>">Shop</a></li>

        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-557">
<a href="<?php echo e(url('/about_us')); ?>">About us</a></li>

<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-557">
  <a href="<?php echo e(url('/contact')); ?>">Contact</a></li>
...
<script src="<?php echo e(asset('modal/modal/js/modal-active.js')); ?>"></script>
  ...
  <?php /**PATH C:\xampp\htdocs\beach_comber\resources\views/inc/mail_footer.blade.php ENDPATH**/ ?>