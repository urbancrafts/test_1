  ...
  <link rel="stylesheet" href="<?php echo e(asset('shopping/css/bootstrap.min.css')); ?>">
    
  <!-- Font Awesome -->
  <link rel="stylesheet" href="<?php echo e(asset('shopping/css/font-awesome.min.css')); ?>">
  
  <!-- Custom CSS -->
  <link rel="stylesheet" href="<?php echo e(asset('shopping/css/owl.carousel.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(asset('shopping/style.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(asset('shopping/css/responsive.css')); ?>">
...
<?php echo $__env->make('layouts.app1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\SONY\Desktop\beach_comber\resources\views/pages/shopping_cart.blade.php ENDPATH**/ ?>