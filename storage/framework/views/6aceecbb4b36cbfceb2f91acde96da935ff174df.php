...
if($.trim($('#name').val()) == ""){
  ...
  <li class="nav-item">
    <a class="nav-link active" href="<?php echo e(url('admin/resort_manager/resort/'.$resorts2[0]->id)); ?>">Edit form</a>
  </li>
  <li class="nav-item">
  ...
  <li class="nav-item">
    <a class="nav-link " href="<?php echo e(url('admin/resort_manager/create_room/'.$resorts2[0]->id)); ?>">Rooms</a>
  </li>
  <!-- <li class="nav-item">
        ...
        <section class="col-lg-7 connectedSortable" id="blog-body">
            ...
            <div class="card card-info">
                <div class="card-header">
                  ...
                  <h3 class="card-title"><i class="fa fa-home"></i> <?php echo e($resorts2[0]->name); ?></h3>
                  <!-- tools box -->
                ...
                <div class="card-body">
                  <form id="update-resort-form" action="<?php echo e(action('App\Http\Controllers\ResortController@update_resort_input')); ?>" method="post" enctype="multipart/form-data">
                   ...
                   <div class="form-group">
                    <label>Resort Name:</label>
                      ...
                      <input type="text" class="form-control" id="name" name="name" placeholder="Resort name" value="<?php echo e($resorts2[0]->name); ?>">
                    </div>
                    ...
                    <div class="form-group">
                      <label>Resort Price:</label>
                        ...
                        <input type="number" class="form-control" id="price" name="price" placeholder="price" value="<?php echo e($resorts2[0]->price); ?>">
                      </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control pac-target-input valid" id="location" name="location" value="<?php echo e($resorts2[0]->location); ?>" data-validation="required" placeholder="Enter a location" autocomplete="off">
                      ...
                      <div class="form-group">
                        ...
                        <input type="url" class="form-control pac-target-input valid" id="youtube" name="youtube" value="<?php echo e($resorts2[0]->youtube); ?>" placeholder="Enter youtube video link" autocomplete="off">
                    ...
                    <div class="form-group">
                      ...
                      <textarea id="address" name="address" placeholder="Resort address"
                                style="width: 100%; height: 70px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo e($resorts2[0]->address); ?></textarea>
                    </div>
                      </div>
                    ...
                    <textarea id="desc" name="desc" placeholder="Enter description"
                                style="width: 100%; height: 70px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo e($resorts2[0]->descr); ?></textarea>
                    </div>
                      </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\SONY\Desktop\beach_comber\resources\views/home/update_resort.blade.php ENDPATH**/ ?>