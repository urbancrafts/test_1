    ...
    <div class="col-xs-12">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Boats Bookings</h3> | <a href="<?php echo e(url('admin/reservations')); ?>" class="fa fa-home">Reservations</a>
        </div>
        <!-- /.box-header -->
        <div class="card-body">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\beach_comber\resources\views/home/bookings.blade.php ENDPATH**/ ?>