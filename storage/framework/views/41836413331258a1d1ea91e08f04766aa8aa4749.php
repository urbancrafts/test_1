...
<div class="foxuries-breadcrumb">
    ...
    <div class="elementor-text-editor elementor-clearfix">
        <?php $__currentLoopData = $contents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $content): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($content->name == "contact_us"): ?>
    ...
    <div class="elementor-widget-container">
    <h3 class="elementor-heading-title elementor-size-default"><?php echo e($settings[0]->address); ?></h3> </div>
    </div>
    </div>
    </div>
    </div>
    ...
    <div class="elementor-widget-container">
    <h3 class="elementor-heading-title elementor-size-default"><?php echo e($settings[0]->tel); ?><br> <?php echo e($settings[0]->phone); ?></h3> </div>
    </div>
    </div>
    </div>
    </div>
    ...
    <div class="elementor-widget-container">
    <h3 class="elementor-heading-title elementor-size-default"><?php echo e($settings[0]->email); ?></h3> </div>
    </div>
    </div>
    </div>
    </div>
    ...
    <form id="contact-form" action="<?php echo e(action('App\Http\Controllers\AjaxRequestController@post_contact_message')); ?>" method="post" class="wpcf7-form init" >
...
<input type="tel" name="phone" id="phone" placeholder="Phone Number" size="40" class="wpcf7-form-control wpcf7-text wpcf7-tel wpcf7-validates-as-required wpcf7-validates-as-tel" aria-required="true" aria-invalid="false" />
    ...
    <div class="elementor-custom-embed">
        <iframe frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?q=<?php echo e($settings[0]->address); ?>&amp;t=m&amp;z=10&amp;output=embed&amp;iwloc=near" aria-label="<?php echo e($settings[0]->address); ?>"></iframe></div> </div>
    </div>
    </div>
    </div>
    </div>
...
<?php echo $__env->make('layouts.app1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\SONY\Desktop\beach_comber\resources\views/pages/contact.blade.php ENDPATH**/ ?>