                ...
                <div class="box-body">
                 ...
                 <li class="item">
                  <div class="product-img">
                    <img src="<?php echo e(asset('storage/img/gallery/'.$gallery->file_1)); ?>" alt="<?php echo e($service->title); ?>">
                  </div>
                  <div class="product-info">
                    <a href="#" class="product-title"><?php echo e($gallery->category); ?>

                      </a>
                    <span class="product-description">
                          <?php echo e($gallery->cnt); ?>

                        </span>
                        <?php if(Auth::user()->role == 1 || Auth::user()->user_type == "admin"): ?>
                     <a href="#" class="fa fa-trash" onclick="deleteGallery('<?php echo e($gallery->id); ?>')" title="Delete <?php echo e($gallery->category); ?>"></a>
                      <?php endif; ?>
                  </div>
                </li>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\beach_comber\resources\views/home/gallery.blade.php ENDPATH**/ ?>