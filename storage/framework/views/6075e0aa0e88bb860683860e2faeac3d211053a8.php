...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Order
        <small>#<?php echo e($orders[0]->id); ?></small>
      </h1>
...
<section class="invoice">
    ...
    <div class="row">
      <div class="col-xs-12">
        <h2 class="page-header">
          <i class="fa fa-book"></i> <?php echo e($orders[0]->name); ?>

          <small class="pull-right">Date: <?php echo e($orders[0]->created_at); ?></small>
        </h2>
      </div>
      <!-- /.col -->
    </div>
    ...
    <div class="row invoice-info">
      <div class="col-sm-4 invoice-col">
        Contact
        <address>
          <strong><?php echo e($orders[0]->phone); ?></strong><br>
    ...
    <div class="row">
      <div class="col-xs-12 table-responsive">
        <table class="table table-striped">
          ...
          <tbody>
          <tr>
            <td><?php echo e($orders[0]->item_name); ?></td>
           
            <td><?php echo e($orders[0]->curr); ?></td>
            <td><?php echo e($orders[0]->unit_price); ?></td>
            <td><?php echo e($orders[0]->qnty); ?></td>
        ...
        <div class="table-responsive">
          <table class="table">
            <tr>
              ...
              <td><?php echo e($orders[0]->curr); ?><?php echo e($orders[0]->unit_price); ?></td>
            </tr>
            
            
            <tr>
              <th>Total:</th>
              <td><?php echo e($orders[0]->curr); ?><?php echo e($orders[0]->unit_price * $orders[0]->qnty); ?></td>
            </tr>
          </table>
        </div>
      </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\beach_comber\resources\views/home/order_page.blade.php ENDPATH**/ ?>