...
<style id='foxuries-style-inline-css' type='text/css'>
            div.foxuries-room{
              background-image: url(<?php echo e($rooms[0]->img_1); ?>);
            }
    </style>
...
<div class="foxuries-room foxuries-breadcrumb">
    <h1 class="breadcrumb-heading">
        <i aria-hidden="true" class="foxuries-icon- foxuries-icon-home"></i><?php echo e($resorts2[0]->name); ?> | 
    ...
    <?php $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
         ...
         <div class="single-room-price-wrap">
            ...
            <span class="price_value price_min" style="font-size: 36px;"><?php echo e($room->curr); ?><?php echo e($room->amount); ?></span>
    ...
    <?php $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div id="hb_widget_search-2" class="widget widget_hb_widget_search"><span class="gamma widget-title">Your Reservation</span>
                ...
                <ul class="hb-form-table">
                    <input type="hidden" name="resort" id="resort" value="<?php echo e($rooms[0]->shelter_id); ?>" />
                    <input type="hidden" name="room" id="room" value="<?php echo e($rooms[0]->id); ?>" />
                    <?php if(Auth::user()): ?>
                    ...
                    <?php endif; ?>
                    <input type="hidden" name="curr" id="curr" value="<?php echo e($rooms[0]->curr); ?>" />
                    <input type="hidden" name="price" id="price" value="<?php echo e($rooms[0]->amount); ?>" />
                    <input type="hidden" name="type" id="type" value="room" />
                    <input type="hidden" name="qnty" id="qnty" value="<?php echo e($rooms[0]->qnty); ?>" />
            ...
            <div id="hb_widget_cart-2" class="widget widget_hb_widget_cart"> 
                ...
                <h3>Unavailable</h3>
                <p class="hb_mini_cart_empty">Sorry, <?php echo e($room->room_no); ?> is booked at the moment</p>
                </div>
                </div>
    ...
    <div class="hb_room_gallery" id="hb_single_room_gallery">
        <?php if($rooms[0]->images): ?>
        <?php $__currentLoopData = $roomImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
       
        <div class="inner">
            <img src="<?php echo e($img); ?>" alt=" Images <?php echo e($img); ?>">
            </div>  
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php endif; ?>
    ...
    <a href="<?php echo e(url('resorts/resort/'.$resorts2[0]->id)); ?>"><i aria-hidden="true" class="foxuries-icon- foxuries-icon-home"></i>Go to Resort Page<<-----</a>
    </div>
    </div>
    ...
    <div class="foxuries-hb-room-sticky">
        ...
        <img width="75" height="65" src="<?php echo e($rooms[0]->img_1); ?>" class="attachment-foxuries-recent-post size-foxuries-recent-post wp-post-image" alt="" /> <div class="foxuries-hb-room-sticky-content">
        <span class="title"><?php echo e($rooms[0]->room_no); ?></span>
        <span>
        <div class="price">
        <span class="title-price">Price</span>
        <span class="price_value price_min"><?php echo e($rooms[0]->curr); ?><?php echo e($rooms[0]->amount); ?></span>
        <span class="unit"><?php echo e($rooms[0]->duration); ?></span>
        </div>
        </span>
        </div>
          ...
          <script>
            ...
            dp.contextMenuResource = new DayPilot.Menu({
                ...
                items: [
                    { text: "Edit...", onClick: async (args) => {
                           const room_capacity = "<?php echo e($rooms[0]->capacity); ?>";
                            const capacities = [
                                {name: "<?php echo e($rooms[0]->capacity); ?>", id: room_capacity},
            ...
            ******************************************/
            ...
            dp.onTimeRangeSelected = async (args) => {
                ...
                const resort_id = "<?php echo e($rooms[0]->shelter_id); ?>";
                const room_id =  "<?php echo e($rooms[0]->id); ?>";
...
<?php echo $__env->make('layouts.app1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\SONY\Desktop\beach_comber\resources\views/pages/room.blade.php ENDPATH**/ ?>