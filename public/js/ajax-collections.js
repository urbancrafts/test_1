		  ...
		  $.fancybox.open([
			{
			  ...
			  autoScale: true,
			  minHeight: 30,
			  content: '<p class="fancybox-error clearfix"><span class="clearfix">' + added_to_collection + '</span> <a class="btn btn-default btn-sm button button-small pop_btn_collection" href="' + mycollections_url + '" title="' + btn_collection + '" target="_top"> <span>' + btn_collection + '<i class="icon-chevron-right right"></i></span></a></p>'
			}
		  ], {
			padding: 0
		  });
